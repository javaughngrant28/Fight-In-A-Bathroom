...
local WeaveRightAnimationTracks: {AnimationTrack}
...
local function UpdateAnimation(animation: Animation)
    ...
    WeaveRightAnimationTracks = loadAnimations.ANIMATIONTRACKS
end
...
ToolDetectore.EquippedSignal:Connect(function(tool: Tool)
    ...
    assert(Animation,`{tool} {Animation} Has No Weave Right Animation`)
...
local function PlayAnimation()
    WeaveRightAnimationTracks[1]:Play()
end
